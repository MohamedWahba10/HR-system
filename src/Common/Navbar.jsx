    ...
    <div className="mt-4 ml-8 mb-0.5 mr-12 bg-backgroundPaper rounded-md shadow-round max-h-16 flex items-center px-4 justify-between font-sans">
      <div className="flex items-center w-full md:w-auto">
        <div className="relative flex items-center w-full md:w-auto">
          <GoSearch className="absolute left-3 text-textprimary" />
          <input
            type="text"
            placeholder="Search"
      ...
      <div className="flex items-center gap-2 text-textPrimary">
        ...
        <img src={icon4} alt="icons" className="w-20 h-20 rounded-full" />

        <div className="relative">
          <FaUserCircle className="text-2xl cursor-pointer" />
          <span className="absolute bottom-0 right-0 block h-2 w-2 bg-success rounded-full ring-2 ring-white"></span>
        </div>
      </div>
    </div>
  );
